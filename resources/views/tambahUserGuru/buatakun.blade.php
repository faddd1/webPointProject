...
<div class="form-container">
    <form action="{{ route('tambahGuru.store') }}" method="POST">
        @csrf
        ...
        <div class="form-group mb-4">
            ...
            <input type="text" id="nis" name="nis" placeholder="NIP" class="form-control">
        </div>
        <div class="form-group mb-4">
        ...
        <div class="form-group mb-4">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="role" id="role" value="Guru" {{ old('role') == 'guru' ? 'checked' : '' }} required>
