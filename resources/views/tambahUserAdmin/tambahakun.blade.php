            ...
            <div class="col-12 col-lg-13">
                ...
                <div class="card">
                    <div class="card-header">
                        <form action="{{ route('tambahAdmin.search') }}" class="form-inline" method="GET">
                            ...
                            <table class="table table-hover table-bordered table-sm" style="background-color: #ffff; font-size: 13px; border-radius: 5px 5px 0 0; overflow: hidden;">
                                <thead>
                                    <tr style="background-color: #4F709C; color:#ffff;">
                                        ...
                                        <th style="text-align: center; vertical-align: middle; white-space: nowrap;">Admin Id</th>
...
<script>
    document.getElementById('search-input').addEventListener('input', function() {
            if (this.value === '') {
                window.location.href = "{{ url('/tambah') }}";
            }
            });
</script>
@include('tambahUserAdmin.confiruserjs')
</x-layout>