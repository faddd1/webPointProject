...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <footer class="main-footer" style="background-color: #f9f9f; color: #333333; padding: 25px 0 0 5px; font-size: 13px; font-family: 'Nunito', sans-serif;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 text-center mb-3 social-section">
                    ...
                    <div class="social-icons" style="font-size: 16px; margin-top: 8px;">
                        <a href="https://www.facebook.com/smkn1kawali" target="_blank" style="color: #4F709C; margin: 0 10px; transition: color 0.3s;">
                            <i class="fab fa-facebook"></i>
                        </a>
                        <a href="https://www.twitter.com/smkn1kawali" target="_blank" style="color: #4F709C; margin: 0 10px; transition: color 0.3s;">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a href="https://www.instagram.com/smkn1kawali" target="_blank" style="color: #4F709C; margin: 0 10px; transition: color 0.3s;">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a href="https://www.youtube.com/smkn1kawali" target="_blank" style="color: #4F709C; margin: 0 10px; transition: color 0.3s;">
                            <i class="fab fa-youtube"></i>
                        </a>
                        <a href="https://www.linkedin.com/smkn1kawali" target="_blank" style="color: #4F709C; margin: 0 10px; transition: color 0.3s;">
